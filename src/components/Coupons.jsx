                    ...
                    <form className='mx-auto  w-full' onSubmit={handleAddCoupon} >
                        ...
                        <div className='flex mt-10 flex-col lg:flex-row'>
                            ...
                            <div className='lg:w-2/3 text-center'>
                                <input className=" text-lg font-semibold h-11  w-full bg-blue-100  border-2 rounded-xl    btn-outline btn-info py-2 px-6 text-blue-950" type='submit' value={`${loading ? '' : "Add"}`} />
