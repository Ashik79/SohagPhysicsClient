...
function UnpaidList() {
    ...
    return (
        (role == 'CEO' || role == 'Manager') ? <div className=''>
            <h1 className=' text-center lg:text-left md:text-center font-semibold text-xl text-cyan-500 underline mt-10'>Unpaid List</h1>
                    ...
                    <div className='grid grid-cols-1 lg:w-2/3 lg:grid-cols-2 gap-3'>
...

                        {
                            paymentStatus != 'All' && <div>
                                <p className='font-semibold'>Unpaid Month  </p>
                                <select
                        ...
                        }
                        {
                            paymentStatus != 'All' &&
                            <div>
                                <p className='font-semibold'>Unpaid Year  </p>
