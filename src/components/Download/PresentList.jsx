...
function PresentList() {
    ...
    return (
        (role == 'CEO' || role == 'Manager') ? <div className=''>
            <h1 className=' text-center lg:text-left md:text-center font-semibold text-xl text-cyan-500 underline mt-10'>Present List</h1>
                    ...
                    <div className='grid grid-cols-1 lg:w-2/3 lg:grid-cols-2 gap-3'>
                        ...
                        <div className='w-full lg:col-span-2 flex gap-1'>
                            ...
                            }
                            {
                                attendanceStatus != 'All' &&
                                <div className='w-1/3'>
                                    <p className='font-semibold'>Present Month  </p>
                                    <select
                            ...
                            }
                            {
                                attendanceStatus != 'All' &&
                                <div className='w-1/3'>
                                    <p className='font-semibold'>Present Year  </p>
