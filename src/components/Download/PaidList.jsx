...
function PaidList() {
    ...
    const handleDownload = async () => {
        ...
        try {
            ...
            if (downloadResponse.ok) {
                ...
                saveAs(blob, `Student_List_${paymentStatus}_${paymentMonth}.xlsx`);
            ...
            console.error(err);
            Swal.fire({ icon: 'error', title: 'Download Failed', text: 'Please check your connection.' });
        } finally {
            setLoading(false);
        }
    }
    ...
    return (
        (role == 'CEO' || role == 'Manager') ? <div className=''>
            <h1 className=' text-center lg:text-left md:text-center font-semibold text-xl text-cyan-500 underline mt-10'>Paid List</h1>
