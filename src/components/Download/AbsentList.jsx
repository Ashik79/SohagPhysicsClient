...
function AbsentList() {
    ...
    return (
        (role == 'CEO' || role == 'Manager') ? <div className=''>
            <h1 className=' text-center lg:text-left md:text-center font-semibold text-xl text-cyan-500 underline mt-10'>Absent List</h1>
                        ...
                        <div className='w-full lg:col-span-2 flex gap-1'>
                            {
                                ...
                                <div className='w-1/3'>
                                    <p className='font-semibold'>Absent Day  </p>
                                    <select
                            ...
                            }
                            {
                                attendanceStatus != 'All' &&
                                <div className='w-1/3'>
                                    <p className='font-semibold'>Absent Month  </p>
                                    <select
                            ...
                            }
                            {
                                attendanceStatus != 'All' &&
                                <div className='w-1/3'>
                                    <p className='font-semibold'>Absent Year  </p>
